...
<div class="w-full h-screen max-h-[100dvh] text-white relative" id="auth-page">
	...
	{#if loaded}
		<div
			class="fixed inset-0 z-50 flex w-full min-h-[100dvh] justify-center overflow-y-auto overscroll-contain bg-transparent text-black dark:text-white"
			id="auth-container"
		>
			<div class="flex min-h-[100dvh] w-full flex-col px-3 text-center sm:px-10">
				{#if ($config?.features.auth_trusted_header ?? false) || $config?.features.auth === false}
